...
class PlantFactory {
  class func createPlant() ->[Plant]{
    ...
    let plant1:[String:Any] = [ "name": "Carrot",
                                "daysToHarvest": 75,
                                "diameter": 6,
                                "varieties": ["General"],
                                "reminders": ["days": 10, "message": "Thin carrots" ],
    ...
    let plant2:[String:Any] = [ "name": "Lettuce",
                                "daysToHarvest": 60,
                                "diameter": 12,
                                "varieties": ["General"],
                                "reminders": [],
    ...
    let plant3:[String:Any] = [ "name": "Radish",
                                "daysToHarvest": 25,
                                "diameter": 6,
                                "varieties": ["General", "Breakfast", "Easter Egg"],
                                "reminders": ["days": 10, "message": "Thin radishes"],
                                "needsFertilizer": false,
                                "slugProne": false,
    ...
    let plant4:[String:Any] = [ "name": "Summer Squash",
                                "daysToHarvest": 55,
                                "diameter": 36,
    ...
    let plant5:[String:Any] = [ "name": "Tomato",
